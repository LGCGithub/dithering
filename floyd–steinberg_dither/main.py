...
directory_pallete = "paletas" + barra

directory = os.listdir(directory_input)

length = 8 # Valores: 2, 4, 8
size = 97 # Tamanho da paleta
mode = 3 # 1 == EGA pallete, 2 == random pallete, 3 == k-means pallete
interacoes = 5


for filename in directory:
    command = "." + barra + "main " + directory_input + filename + " " + directory_output + filename + " " + directory_pallete + filename + " " + str(length) + " " + str(mode) + " " + str(size) + " " + str(interacoes)
    print(command)
    os.system(command)